...
This increased tension causes the speed of light (c) to obey the TIC delay. This is an axiom of DUT: if mass is structured upon a metric of extreme cellular pattern density, time itself is lower than in the structure of space devoid of mass.

It is the same effect observed in a black hole, where time is reduced towards zero. In DUT, this is not due to infinite curvature, but due to maximum cellular density — the TIC can no longer update, and therefore time ceases.

#### Proportional Effect at Non-Critical Density

At non-critical density, the effect remains, but proportionally less. The framework is still tense, but not maximally tense. The TIC delay still occurs, but it is small.
